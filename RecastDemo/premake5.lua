...
-- 在 workspace 配置段后添加 RecastBuilder 项目
project "RecastBuilder"
	...
	includedirs { 
		...
		"../DetourTileCache/Include",
		"../Recast/Include",
		"../RecastBuilder/Cmd"  -- 添加你的头文件目录
	}
	files {
		"../RecastBuilder/Cmd/*.h",
		"../RecastBuilder/Cmd/*.cpp",
		"../RecastBuilder/RecastBuilder.cpp",
	}
	...
	-- 统一平台配置（在原有 windows filter 中添加）
	filter {"system:windows", "platforms:Win32"}
		architecture "x86"
		targetdir ( todir .. "/Bin/Win32" )
